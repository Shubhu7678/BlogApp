...
import { setEditBlog, setBlog } from '../../../../slices/blogSlice';
import { useDispatch, useSelector } from 'react-redux';
import { useParams } from 'react-router-dom';
import { getBlogDataById } from '../../../../services/operations/blogApi';
...
const EditBlog = () => {
  ...
  useEffect(() => {
    ...
    const getBlogData = async () => {
      if (blogId && editBlog) {
        ...
        // Fetch blog data for edit here
        const BlogData = await getBlogDataById(blogId, token);
  ...
  }, [dispatch, blogId, editBlog, token])
      ...
      <div className=" w-[850px]  flex gap-4 mx-auto pt-8">
        ...
        <div className="pl-8 pr-8 py-4 w-[40%] h-fit bg-gray-800">
          ...
          <ul className="text-gray-200 list-disc flex flex-col gap-1 text-sm">
            ...
            <li>Write a brief summary to outline the blogs key points.</li>
